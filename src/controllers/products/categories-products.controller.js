...
export const saveCategoriesProducts = async (req, res) => {
...
// Update table data
export const updateCategoriesProducts = async (req, res) => {
...
export const deleteCategoriesProducts = async (req, res) => {
    // From URL
    // const { id } = req.params;
