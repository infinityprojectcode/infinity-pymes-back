...
export const saveSupplierCategories = async (req, res) => {
...
// Update table data
export const updateSupplierCategories = async (req, res) => {
...
export const deleteSupplierCategories = async (req, res) => {
    // From URL
    // const { id } = req.params;
