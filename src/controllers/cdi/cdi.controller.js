...
export const getCdi = async (req, res) => {
...
export const saveCdi = async (req, res) => {
    ...
    const insert = await conn.query(
        `INSERT INTO ${db}.CDI (column1, column2) VALUES (?, ?)`,
        [column1, column2]
    );
...
// Update table data
export const updateCdi = async (req, res) => {
    ...
    try {
        ...
        const update = await conn.query(
            `UPDATE ${db}.CDI SET column1 = ?, column2 = ? WHERE id = ?`,
            [column1, column2, id]
        );
...
export const deleteCdi = async (req, res) => {
    // From URL
    // const { id } = req.params;
